export default function Home() {
  ...
  const PROJECTS = [
    {
      ...
      summary:
        "Configured and tested reverse power flow protection with SEL-751: logic programming, simulation, field testing, and fault analysis for reliable feeder operation.",
    },
    {
      title: "Transformer Differential Protection - Inrush and CT Saturation",
      summary:
        "Modeled differential protection with harmonic restraint, simulated CT saturation, and analyzed waveforms to select secure and sensitive pickup settings.",
    },
    {
  ...
  // Gmail compose URL (works even if no default mail app)
  const gmailCompose =
    "https://mail.google.com/mail/?view=cm&fs=1&to=gpatil3@mtu.edu&su=Hello%20Gaurav&body=Hi%20Gaurav%2C";
  const telHref = "tel:+19063198940";
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center rounded-full px-4 py-2 text-sm border hover:bg-slate-200 transition-colors"
            >
              in LinkedIn
            </a>
          </div>
      ...
      <section id="contact" className="mx-auto max-w-6xl px-4 py-10">
        <div className="border rounded-2xl p-5 bg-white">
          ...
          <p className="text-slate-700 mb-4">
            Best way to reach me is via email or phone. I am open to Spring/Summer 2026 internships,
            co-ops, and full time roles in Protection & Control.
          </p>
